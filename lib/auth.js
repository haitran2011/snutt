...
exports.local_auth = local_auth;
function fb_auth(fb_id, fb_token, done) {
    if (process.env.NODE_ENV == 'mocha') {
        if (fb_token == 'correct' && fb_id == "1234")
            return done(null, null, { fb_name: "John", fb_id: "1234" });
        if (fb_token == 'correct2' && fb_id == "12345")
            return done(null, null, { fb_name: "Smith", fb_id: "12345" });
