...
/**
 * >>> : Zero-fill shift
 * MongoDB do not accept negative number for $bitsAllClear
 */
function timeMasksToBinaryConditions(timeMask) {
  return timeMask.map(function(bit, idx) {
...
var compareLecture = function(oldl, newl) {
...
module.exports = {
  ...
  timeMasksToBinaryConditions: timeMasksToBinaryConditions,
  timeJsonToMask: timeJsonToMask,
  compareLecture: compareLecture};
