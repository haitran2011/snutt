...
exports.timeAndPlaceToJson = timeAndPlaceToJson;
function equalTimeJson(t1, t2) {
...
exports.equalTimeJson = equalTimeJson;
...
exports.timeJsonToMask = timeJsonToMask;
/**
    ...
    if (object && typeof (object) != 'string' &&
        ...
        if (typeof (object.length) == 'undefined') {
            ...
            for (var key in object) {
                if (object.hasOwnProperty(key) && object[key]._id)
                    object_del_id(object[key]); //recursive del calls on object elements
            }
        }
        else {
...
exports.object_del_id = object_del_id;
;
/**
        ...
        if (typeof (object.length) == 'undefined' && '_id' in object) {
            ...
            for (var key in object) {
                if (object.hasOwnProperty(key))
                    object_new_id(object[key]); //recursive del calls on object elements
            }
        }
        else {
            for (var i = 0; i < object.length; i++) {
...
exports.object_new_id = object_new_id;
;
function compareLecture(oldl, newl) {
    ...
    if (Object.keys(updated.after).length === 0)
        updated = null;
    return updated;
}
exports.compareLecture = compareLecture;
;
